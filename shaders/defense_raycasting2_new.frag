...
uniform bool hmd;
uniform bool insideVolume = false;
...
void computeIntersections()
{
	...
	if (insideVolume) {
        ...
        //startPt = preMult(vec3(gl_FragCoord.x - offS, gl_FragCoord.y, 0.0), viewToWorldMatrix);
