...
#ifndef VIPRE_STRING_HPP
#define VIPRE_STRING_HPP
 ...
 */
class VIPRE_EXPORT String : public std::string
{
public:
...
// Typedefs
typedef std::vector<vipre::String> StringList;

}   // End of vipre namespace

#endif  // End of VIPRE_STRING_HPP
